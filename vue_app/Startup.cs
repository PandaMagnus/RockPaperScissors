    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                //Microsoft.AspNetCore.SpaServices.SpaOptions test = new Microsoft.AspNetCore.SpaServices.SpaOptions();
                //test.
                //app.
                var test = Path.Combine(env.ContentRootPath, @"node_modules\@vue\cli-service\webpack.config.js");
